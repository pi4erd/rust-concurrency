...
impl<'w> VoxelGame<'w> {
    pub async fn new(window: Arc<Window>) -> Self {
        ...
        let surface_config = wgpu::SurfaceConfiguration {
            ...
            format: surface_caps
                ...
                .into_iter()
                .find(|f| f.is_srgb())
                .expect("No srgb format was available"),
            width: size.width,
            height: size.height,
        ...
        let (bind_groups, bind_layouts) =
            Self::create_bind_groups(&device, &uniform_buffers, &textures);

        let depth_texture =
            Texture2d::create_depth_texture(&device, &surface_config, Some("depth_texture"));

        let pipelines = Self::create_pipelines(&device, &surface_config, &bind_layouts);
    ...
    fn create_pipelines(
        ...
        let debug_pipeline = device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
            ...
            vertex: wgpu::VertexState {
                ...
                entry_point: Some("vs_main"),
                compilation_options: wgpu::PipelineCompilationOptions::default(),
                buffers: &[DebugVertex::desc(), DebugModelInstance::desc()],
            },
            fragment: Some(wgpu::FragmentState {
                module: &debug_module,
                entry_point: Some("fs_main"),
    ...
    fn update(&mut self, delta: f32) {
        ...
        for _ in 0..64 {
            self.world
                .dequeue_meshgen(&self.device, &self.queue, &self.bind_layouts["model"]);
        }
    ...
    fn render(&mut self) -> Result<(), wgpu::SurfaceError> {
        ...
        let chunks_drawn;
        {
            ...
            chunks_drawn = self
                .world
                .draw_distance(&mut opaque_pass, self.camera.eye.to_vec(), 16);
        }
    ...
    fn resize(&mut self, new_size: PhysicalSize<u32>) {
        ...
        self.camera
            .change_aspect(new_size.width as f32 / new_size.height as f32);
